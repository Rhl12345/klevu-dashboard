...
import { IAllProductsTabProps } from "@/types/store-brand/storeBrand.type";
...
const AllProductsTab = ({
  ...
  const handleCheckboxChange = (product: IProductModalProps) => {
  ...
  const isProductSelected = (product: IProductModalProps) => {
    ...
    <div className="w-full flex flex-col gap-4 lg:gap-6 bg-body-light dark:bg-body-dark relative h-[calc(100vh-10rem)] overflow-hidden overflow-y-auto">
      <div className="border border-gray-light dark:border-gray-dark">
        <div className="grid grid-cols-1 md:grid-cols-2 p-4 lg:p-6 gap-4 lg:gap-6 overflow-hidden">
          {AllProductsData.map((product: IProductModalProps) => (
            <div
              key={product.sku}
              className="flex items-center px-6 py-4 border border-gray-light dark:border-gray-dark rounded-none"
            >
              <div className="w-8">
                <Checkbox
                  id={product.sku}
