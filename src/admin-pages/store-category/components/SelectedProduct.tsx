...
import { IcategoryProductModalProps } from "@/types/store-category/storeCategory.type";
...
const SelectedProductsTab = ({
  ...
  selectedRows: IcategoryProductModalProps[];
  setSelectedRows: React.Dispatch<
    React.SetStateAction<IcategoryProductModalProps[]>
  >;
}) => {
